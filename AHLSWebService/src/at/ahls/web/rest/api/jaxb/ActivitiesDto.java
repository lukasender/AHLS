...
public class ActivitiesDto {
    ...
    protected List<ActivitiesDto.Activity> activity;
     ...
     * {@link ActivitiesDto.Activity }
     * 
     * 
     */
    public List<ActivitiesDto.Activity> getActivity() {
        if (activity == null) {
            activity = new ArrayList<ActivitiesDto.Activity>();
        }
